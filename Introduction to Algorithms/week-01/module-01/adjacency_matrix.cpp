...
{
    int n, e;
    cin >> n >> e; // Input number of nodes (n) and edges (e)

    int mat[n][n];               // Initialize adjacency matrix for the graph
    memset(mat, 0, sizeof(mat)); // Set all elements of the matrix to 0 (no edges initially)
